...
class Location_2 extends ConsumerStatefulWidget {
const Location_2({Key? key}) : super(key: key);

@override
_Location_2State createState() => _Location_2State();
}

class _Location_2State extends ConsumerState<Location_2> {
...
markerIcon =
await getBytesFromAsset('assets/bg.jpeg', 75);
else if (types.contains('food'))
markerIcon = await getBytesFromAsset('assets/bg.jpeg', 75);
